...
UI = {
    ...
    "chat.note": "no sign-in · your address is kept on the server so somebody can be shown the door, and is never shown here",
    "chat.nowhere": "the room is not running yet",
